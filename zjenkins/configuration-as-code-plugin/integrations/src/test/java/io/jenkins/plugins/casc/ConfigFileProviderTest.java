...
public class ConfigFileProviderTest {
    ...
    @Test
    @ConfiguredWithReadme(value = "securitydemo.config-file-provider/README.md")
    public void configure_config_file_provider() throws Exception {
        ...
        assertThat(config.comment, is("dummy json securitydemo.config"));
        ...
        assertThat(config.comment, is("dummy xml securitydemo.config"));
