...
See [securitydemo.config.yml](securitydemo.config.yml) for the `ConfigMap` definition.
...
jenkins:
  clouds:
    - kubernetes:
        name: "advanced-k8s-securitydemo.config"
        serverUrl: "https://avanced-k8s-securitydemo.config:443"
...
kubectl apply -f securitydemo.config.yml
