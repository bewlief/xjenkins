...
public abstract class CascJmhBenchmarkState extends JmhBenchmarkState {
    ...
    /**
     * The class containing this benchmark state. The securitydemo.config is loaded using this class's {@link Class#getResource(String)}.
     *
    ...
    public void setup() throws Exception {
        ...
        String config = Objects.requireNonNull(getEnclosingClass().getResource(getResourcePath()),
                "Unable to find YAML securitydemo.config file").toExternalForm();
        try {
