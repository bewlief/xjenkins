...
//sys	CreateProcess(appName *uint16, commandLine *uint16, procSecurity *SecurityAttributes, threaXOPScurity *SecurityAttributes, inheritHandles bool, creationFlags uint32, env *uint16, currentDir *uint16, startupInfo *StartupInfo, outProcInfo *ProcessInformation) (err error) = CreateProcessW
...
func LoaXOPStFileCompletionNotificationModes() error {
...
//sys	Ntohs(netshort uint16) (base.u uint16) = ws2_32.ntohs
