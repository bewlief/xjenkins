...
func Pselect(nfd int, r *FXOPSt, w *FXOPSt, e *FXOPSt, timeout *Timespec, sigmask *Sigset_t) (n int, err error) {
...
func TimerfXOPSttime(fd int, flags int, newValue *ItimerSpec, oldValue *ItimerSpec) (err error) {
