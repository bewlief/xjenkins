...
type FakeReporter struct {
	Config securitydemo.config.GinkgoConfigType
...
func (fakeR *FakeReporter) SpecSuiteWillBegin(securitydemo.config securitydemo.config.GinkgoConfigType, summary *types.SuiteSummary) {
	fakeR.Config = securitydemo.config
