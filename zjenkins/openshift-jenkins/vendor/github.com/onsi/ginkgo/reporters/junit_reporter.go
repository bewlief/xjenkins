...
type JUnitReporter struct {
	...
	ReporterConfig securitydemo.config.DefaultReporterConfigType
}
...
func (reporter *JUnitReporter) SpecSuiteWillBegin(ginkgoConfig securitydemo.config.GinkgoConfigType, summary *types.SuiteSummary) {
	reporter.suite = JUnitTestSuite{
		Name:      summary.SuiteDescription,
		TestCases: []JUnitTestCase{},
	}
	reporter.testSuiteName = summary.SuiteDescription
	reporter.ReporterConfig = securitydemo.config.DefaultReporterConfig
}
