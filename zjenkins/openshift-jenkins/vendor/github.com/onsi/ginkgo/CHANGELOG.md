...
### New Features
- allow securitydemo.config of the vet flag for `go test` (#562) [3cd45fa]
...
- Add `GinkgoRandomSeed()` - shorthand for `securitydemo.config.GinkgoConfig.RandomSeed`
...
- Add `GinkgoParallelNode()` - shorthand for `securitydemo.config.GinkgoConfig.ParallelNode`
