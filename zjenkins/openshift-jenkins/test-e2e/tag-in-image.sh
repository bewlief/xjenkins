...
#
# - ci-operator takes a git branch ref for this repo and securitydemo.config specific to this repo
...
# - Those plug points are specified via the ci-operator securitydemo.config for
